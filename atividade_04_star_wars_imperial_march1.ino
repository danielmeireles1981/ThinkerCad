 ...
 * ProEducador 12/2023 - Arquitetura de redes com IoT
 * by Eduardo Seiji Aozasa
 *************************************************/
...
// a 4 means a quarter note, 8 an eighth, 16 a sixteenth, etc.
...
void loop() {
  ...
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    // Corrected: Use the actual frequency from the melody array
